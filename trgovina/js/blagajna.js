...
function renderSummary() {
  ...
  itemsEl.innerHTML = cart.map(item => `
    <div class="order-item">
      <div class="order-item__name">${item.name}<br><small style="color:rgba(43,11,57,.4);font-size:.75rem">${item.variantLabel || ''}</small></div>
      <div class="order-item__qty">${item.quantity}×</div>
      <div class="order-item__price">${fmt(Number(item.price) * item.quantity)}</div>
    </div>`).join('');
...
<div class="wrap">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
          <tr>
            <td bgcolor="#f7f3ee" style="background:#f7f3ee;vertical-align:middle">
              <img src="https://gomushroom.si/assets/logo-email.png" alt="GoMushroom" width="128" height="44" style="display:block;height:44px;width:128px;border:0;outline:none;text-decoration:none">
            </td>
  ...
  <div style="background:#f7f3ee;padding:1rem 1.5rem;border-top:1px solid #ede6d6;font-size:.68rem;color:#9a8f82;line-height:1.7">
    ...
    <a href="mailto:info@gomushroom.si" style="color:#af8455;text-decoration:none">info@gomushroom.si</a> ·
    <a href="https://gomushroom.si" style="color:#af8455;text-decoration:none">gomushroom.si</a>
  </div>
</div>
</body></html>`;
  ...
  <div style="max-width:600px;margin:0 auto;background:#fff">
    <div style="background:#f7f3ee;padding:1.5rem;border-bottom:2px solid #af8455">
      <div style="display:flex;justify-content:space-between;align-items:flex-start">
        <div>
          <img src="https://gomushroom.si/assets/logo-email.png" alt="GoMushroom" width="160" height="55" style="display:block;width:160px;height:55px;margin-bottom:.35rem;border:0;outline:none;text-decoration:none">
